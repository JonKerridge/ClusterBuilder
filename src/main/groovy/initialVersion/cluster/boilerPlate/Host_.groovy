package initialVersion.cluster.boilerPlate
 ...
 * Thus Host has to be modified for each solution.
 */

class Host_ {
  public static void main(String[] args) {
    int nodes = 1   // this value should be modified using clusterScript.gpp by the Builder from //@ Cluster integer
                    // should probably be read in as an argument
...
// read IP addresses  from nodes and create response channels
    ...
    for ( n in 0 ..< nodes ) {
      ...
      nodeIPs << nodeIP
      def nodeAddress = new TCPIPNodeAddress(nodeIP, 2000)
