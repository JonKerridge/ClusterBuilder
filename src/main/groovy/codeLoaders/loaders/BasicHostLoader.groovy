...
import codeLoaders.basicProcesses.BasicHostProcess
import codeLoaders.basicProcesses.BasicNodeProcess
...
The name of the node process, currently BasicNodeProcess and

The name of the host process, currently BasicHostProcess
 */
